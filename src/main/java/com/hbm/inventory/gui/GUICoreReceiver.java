...
public class GUICoreReceiver extends GuiInfoContainer {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		this.receiver.tank.renderTankInfo(this, mouseX, mouseY, this.guiLeft + 8, this.guiTop + 17, 16, 52);
	}
	...
	protected void drawGuiContainerForegroundLayer( int i, int j) {
		...
		this.fontRendererObj.drawString(BobMathUtil.getShortNumber(this.receiver.joules) + "Spk", 50, 35, 0xFF7F7F);
		this.fontRendererObj.drawString("Output:", 40, 45, 0xFF7F7F);
		this.fontRendererObj.drawString(BobMathUtil.getShortNumber(this.receiver.joules * 5000) + "HE", 50, 55, 0xFF7F7F);
	...
	protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
		...
		Minecraft.getMinecraft().getTextureManager().bindTexture(GUICoreReceiver.texture);
		drawTexturedModalRect(this.guiLeft, this.guiTop, 0, 0, this.xSize, this.ySize);

		this.receiver.tank.renderTank(this.guiLeft + 8, this.guiTop + 69, this.zLevel, 16, 52);
	}
}
