...
public class GUINukeFleija extends GuiContainer {
	...
	protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
		...
		Minecraft.getMinecraft().getTextureManager().bindTexture(GUINukeFleija.texture);
		...
		{
			drawTexturedModalRect(this.guiLeft + 57, this.guiTop + 105, 176, 90, 18, 14);
		}
		...
		{
			drawTexturedModalRect(this.guiLeft + 103, this.guiTop + 77, 194, 20, 18, 15);
		}
		...
		{
			drawTexturedModalRect(this.guiLeft + 103, this.guiTop + 92, 194, 35, 18, 12);
		}
		
		if(this.testNuke.slots[9] != null && this.testNuke.slots[9].getItem() == ModItems.fleija_core)
		{
			drawTexturedModalRect(this.guiLeft + 85, this.guiTop + 104, 176, 47, 18, 15);
		}
		
		if(this.testNuke.slots[10] != null && this.testNuke.slots[10].getItem() == ModItems.fleija_core)
		{
			drawTexturedModalRect(this.guiLeft + 103, this.guiTop + 104, 194, 47, 18, 15);
		}
	}
}
