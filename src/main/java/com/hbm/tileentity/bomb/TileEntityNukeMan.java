...
public class TileEntityNukeMan extends TileEntity implements ISidedInventory, IGUIProvider {
	...
	public String getInventoryName() {
		return hasCustomInventoryName() ? this.customName : "container.nukeMan";
	}
	...
	public boolean isReady() {
		...
		{
			if(this.slots[0] != null && this.slots[5] != null && this.slots[0].getItem() == ModItems.man_igniter && this.slots[5].getItem() == ModItems.man_core)
			{
				return true;
			}
		}
