...
public class TileEntityNukeGadget extends TileEntity implements ISidedInventory, IGUIProvider {
	...
	public String getInventoryName() {
		return hasCustomInventoryName() ? this.customName : "container.nukeGadget";
	}
	...
	public boolean isReady() {
		...
		{
			if(this.slots[0] != null && this.slots[5] != null && this.slots[0].getItem() == ModItems.gadget_wireing && this.slots[5].getItem() == ModItems.gadget_core)
			{
				return true;
			}
		}
