...
public class TileEntityNukeTsar extends TileEntity implements ISidedInventory, IGUIProvider {
	...
	public String getInventoryName() {
		return hasCustomInventoryName() ? this.customName : "container.nukeTsar";
	}
	...
	public boolean isFilled() {
		...
		if(this.slots[0] != null && this.slots[1] != null && this.slots[2] != null && this.slots[3] != null && this.slots[4] != null && this.slots[5] != null)
			if(this.slots[0].getItem() == ModItems.explosive_lenses && 
			this.slots[1].getItem() == ModItems.explosive_lenses && 
			this.slots[2].getItem() == ModItems.explosive_lenses && 
			this.slots[3].getItem() == ModItems.explosive_lenses && 
			this.slots[4].getItem() == ModItems.man_core && 
			this.slots[5].getItem() == ModItems.tsar_core)
			{
				return true;
			}
