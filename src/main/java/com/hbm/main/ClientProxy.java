...
import com.hbm.render.block.RenderNarrowCurveRail;
import com.hbm.render.block.RenderNarrowStraightRail;
...
import com.hbm.render.block.RenderStandardBufferRail;
import com.hbm.render.block.RenderStandardCurveRail;
import com.hbm.render.block.RenderStandardRampRail;
import com.hbm.render.block.RenderStandardStraightRail;
...
public class ClientProxy extends ServerProxy {
	...
	public void vanish(int ent) {
		this.vanished.put(ent, System.currentTimeMillis() + 2000);
	}
	
	@Override
	public boolean isVanished(Entity e) {
		
		if((e == null) || !this.vanished.containsKey(e.getEntityId()))
			return false;
