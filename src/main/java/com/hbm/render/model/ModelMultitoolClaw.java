...
public class ModelMultitoolClaw extends ModelBase {
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		this.Base.render(f5);
		this.BTop.render(f5);
		this.BBottom.render(f5);
		this.BLeft.render(f5);
		this.BRight.render(f5);
		this.RTop.render(f5);
		this.RBottom.render(f5);
		this.RLeft.render(f5);
		this.RRight.render(f5);
		this.GPivot.render(f5);
		this.GBase.render(f5);
		this.F31.render(f5);
		this.F21.render(f5);
		this.F41.render(f5);
		this.F51.render(f5);
		...
		this.F53.render(f5);
		this.F13.render(f5);
		this.WireL.render(f5);
		this.WireR.render(f5);
		this.Gauge1.render(f5);
		this.Gauge2.render(f5);
		this.WireB.render(f5);
	}
