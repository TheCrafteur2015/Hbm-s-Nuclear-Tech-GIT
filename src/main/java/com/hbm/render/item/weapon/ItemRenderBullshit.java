...
public class ItemRenderBullshit implements IItemRenderer {
	...
	public ItemRenderBullshit() {
		...
		this.mp40 = new ModelMP40();
		this.bomb = new ModelBaleflare();
	}
	...
	private void renderWhatever(ItemRenderType type, ItemStack item, Object... data) {
		...
		GL11.glScalef(0.75F, 0.75F, 0.75F);
		this.mp40.render((Entity)data[1], 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
		...
		this.bomb.render((Entity)data[1], 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
	}
}
