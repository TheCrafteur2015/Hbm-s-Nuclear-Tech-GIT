...
public class ItemRenderUACPistol implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		GL11.glPushMatrix();
		this.mc.renderEngine.bindTexture(ResourceManager.uac_pistol_tex);
		...
		case ENTITY:// Dropped item
			GL11.glScalef(ItemRenderUACPistol.scale1, ItemRenderUACPistol.scale1, ItemRenderUACPistol.scale1);
			break;
		case EQUIPPED:// In hand from other's POV
			GL11.glScalef(ItemRenderUACPistol.scale2, ItemRenderUACPistol.scale2, ItemRenderUACPistol.scale2);
			GL11.glRotatef(90F, 0F, 1F, 0F);
			GL11.glRotatef(-45F, 1F, 0F, 0F);
			GL11.glTranslatef(0F, -12F, 30F);

			GL11.glPushMatrix();
			ResourceManager.uac_pistol.renderOnly(ItemRenderUACPistol.trigger, ItemRenderUACPistol.mag, ItemRenderUACPistol.lower);
			GL11.glPopMatrix();

			GL11.glPushMatrix();
			GL11.glTranslated(slideAnim[0], slideAnim[1], slideAnim[2] * 2);
			ResourceManager.uac_pistol.renderPart(ItemRenderUACPistol.slide);
			GL11.glPopMatrix();

			GL11.glPushMatrix();
			GL11.glRotated(hammerAnim[0], 1F, 0F, 0F);
			ResourceManager.uac_pistol.renderPart(ItemRenderUACPistol.hammer);
			GL11.glPopMatrix();
			break;
		case EQUIPPED_FIRST_PERSON:// In hand from POV
			GL11.glScalef(ItemRenderUACPistol.scale3, ItemRenderUACPistol.scale3, ItemRenderUACPistol.scale3);
			GL11.glRotatef(90F, 0F, 1F, 0F);
			...
			break;
		case INVENTORY:
			GL11.glScalef(ItemRenderUACPistol.scale4, ItemRenderUACPistol.scale4, ItemRenderUACPistol.scale4);
			GL11.glRotatef(90F, 0F, 1F, 0F);
