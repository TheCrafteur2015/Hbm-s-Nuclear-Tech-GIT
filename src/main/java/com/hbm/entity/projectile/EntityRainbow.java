...
public class EntityRainbow extends Entity implements IProjectile
{
    ...
    public void randomizeColor() {
    	this.dataWatcher.updateObject(20, (byte)this.rand.nextInt(2));
    	this.dataWatcher.updateObject(21, (byte)this.rand.nextInt(2));
    	this.dataWatcher.updateObject(22, (byte)this.rand.nextInt(2));
    }
}
