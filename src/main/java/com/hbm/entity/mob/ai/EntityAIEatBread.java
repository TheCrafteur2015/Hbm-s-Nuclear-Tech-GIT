...
public class EntityAIEatBread extends EntityAIBase {
	...
	public boolean shouldExecute() {
		if(this.pigeon.isFat() || this.pigeon.getFlyingState() != IFlyingCreature.STATE_WALKING) return false;

		List<EntityItem> items = this.pigeon.worldObj.getEntitiesWithinAABB(EntityItem.class, this.pigeon.boundingBox.expand(10, 10, 10));
