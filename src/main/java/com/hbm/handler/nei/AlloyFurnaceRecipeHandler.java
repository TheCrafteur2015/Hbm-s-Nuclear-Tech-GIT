...
public class AlloyFurnaceRecipeHandler extends TemplateRecipeHandler {
	...
	public class SmeltingSet extends TemplateRecipeHandler.CachedRecipe {
		...
		public List<PositionedStack> getIngredients() {
			return getCycledIngredients(AlloyFurnaceRecipeHandler.this.cycleticks / 48, Arrays.asList(new PositionedStack[] { this.input1, this.input2 }));
		}

		@Override
		public PositionedStack getOtherStack() {
			return AlloyFurnaceRecipeHandler.fuels.get((AlloyFurnaceRecipeHandler.this.cycleticks / 48) % AlloyFurnaceRecipeHandler.fuels.size()).stack;
		}
	...
	public void loadTransferRects() {
		this.transferRects.add(new RecipeTransferRect(new Rectangle(96, 25, 24, 18), "alloysmelting"));
	}
	...
	public TemplateRecipeHandler newInstance() {
		if(AlloyFurnaceRecipeHandler.fuels == null || AlloyFurnaceRecipeHandler.fuels.isEmpty())
			AlloyFurnaceRecipeHandler.fuels = new ArrayList<>();
		for(ItemStack i : MachineRecipes.instance().getAlloyFuels()) {
			AlloyFurnaceRecipeHandler.fuels.add(new Fuel(i));
		}
